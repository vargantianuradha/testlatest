...
<c:when test='<%= SessionMessages.contains(request, "userAdded") %>'>
	...
	<p> Thank you for creating an account on the City of Kingston's My City Portal.</p>
	<p> To finalize the process, we need to verify your email address:</p> 
	<ol> 
		<li> A verification email has been sent to the email address provided.</li>
		<li> Follow the instructions in the email to complete your registration.</li>
		<li> Upon completion, you will be able to use your email address and password entered in the previous step to access the City of Kingston's "My City" portal.</li>
	</ol>
	<p> If you have any issues or concerns, please <a href="/contact-us">contact us</a> for further help.</p>
	<p> <a href="/" class="rounded-button-link">Go To City Home</a></p>
