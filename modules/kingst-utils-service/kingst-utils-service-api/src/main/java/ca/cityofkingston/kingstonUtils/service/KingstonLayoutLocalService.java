...
/**
 * Provides the local service interface for KingstonLayout. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see KingstonLayoutLocalServiceUtil
...
public interface KingstonLayoutLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KingstonLayoutLocalServiceUtil} to access the kingston layout local service. Add custom service methods to {@link ca.cityofkingston.kingstonUtils.service.impl.KingstonLayoutLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public KingstonLayout addKingstonLayout(KingstonLayout kingstonLayout);
	...
	*/
	public KingstonLayout createKingstonLayout(long kId);
	...
	*/
	...
	public KingstonLayout deleteKingstonLayout(KingstonLayout kingstonLayout);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public KingstonLayout deleteKingstonLayout(long kId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public KingstonLayout fetchKingstonLayout(long kId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public KingstonLayout getKingstonLayout(long kId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public KingstonLayout updateKingstonLayout(KingstonLayout kingstonLayout);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<KingstonLayout> getKingstonLayouts(int start, int end);
