		...
		<liferay-frontend:fieldset-group>
			<liferay-frontend:fieldset>
				...
				<aui:select name="preferences--displayStyle--" value="<%= displayStyle %>">
					...
					<aui:option label="kingston-blog-aggregator" selected='<%= displayStyle.equals("kingston-blog-aggregator") %>' />
					<aui:option label="kingston-mcp-blog-aggregator" selected='<%= displayStyle.equals("kingston-mcp-blog-aggregator") %>' />
				</aui:select>
